    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl: "https://github.com/fhenixprotocol/fhenix-docs/tree/main/",
        },
        theme: {
    ...
    metadata: [
      {
        name: "keywords",
        content:
          "Fhenix, Blockchain, FHE, Fully Homomorphic Encryption, Layer 2, L2, Coprocessor, Blockchain Technology, Secure Computing, Scalable Blockchain, Decentralized",
      },
