...
```javascript
const networkPkSig = web3.eth.abi.encodeFunctionSignature("getNetworkPublicKey(int32)");
...
```shell
cast call 0x0000000000000000000000000000000000000080 --rpc-url "https://api.helium.fhenix.zone" "getNetworkPublicKey(int32)" "0"
```
</TabItem>
</Tabs>
